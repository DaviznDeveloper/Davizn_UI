...
/////////////////////////////////////////////////////////////////////// 2010.08.20 min add
	$NICUPLOAD_PATH = '../updata' ;
	$NICUPLOAD_URI = 'updata' ;

	$upPath =$_POST['upPath'] ;
	if($upPath) {
		$NICUPLOAD_PATH .=	'/'.$upPath;
		$NICUPLOAD_URI .=	'/'.$upPath;
	}
	if (!is_dir($NICUPLOAD_PATH)) {
		$mkrs = @mkdir( $NICUPLOAD_PATH, '0777' );
		chmod( $NICUPLOAD_PATH, 0777);
	}
////////////////////////////////////////////////////////////////////////
define('NICUPLOAD_PATH', $NICUPLOAD_PATH); // Set the path (relative or absolute) to
define('NICUPLOAD_URI', $NICUPLOAD_URI);   // Set the URL (relative or absolute) to
